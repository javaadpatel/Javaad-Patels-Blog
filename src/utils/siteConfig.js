module.exports = {
    siteUrl: `https://javaadpatel.com`, // Site domain. Do not include a trailing slash!

    postsPerPage: 18, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

    googleAnalyticsBaseUrl: "https://javaad-google-analytics.netlify.app",
    ...
    shortTitle: `Javaad Patel's Blog`, // Used for App manifest e.g. Mobile Home Screen
